  ...
  'book': {
    en: [
      ...
      ['Can you accommodate child seats and large groups?',
       'Yes. Free child seats are available on request when booking — please specify ages in the booking form. For groups up to 16 passengers we use Sprinter vans; larger groups use shuttle buses up to 50 passengers. Let us know your group size and we’ll recommend the right vehicle.'],
    ],
    es: [
      ...
      ['¿Manejan sillas infantiles y grupos grandes?',
       'Sí. Las sillas infantiles son gratis bajo petición al reservar — por favor especifica edades en el formulario. Para grupos hasta 16 pasajeros usamos Sprinter vans; grupos más grandes en autobús hasta 50 pasajeros. Dinos el tamaño del grupo y te recomendamos el vehículo.'],
    ],
  },
  ...
  'hotel-to-hotel': {
    en: [
      ...
      ['What types of vehicles are used for hotel-to-hotel service?',
       'We use air-conditioned SUVs for 1–4 passengers, Sprinter vans for 5–16 passengers, and shuttle buses for groups of 17+. All vehicles are late-model and fully licensed for tourist transportation under Mexican SECTUR regulations.'],
    ],
    es: [
      ...
      ['¿Qué tipo de vehículos usan para el servicio hotel a hotel?',
       'Usamos SUVs con aire acondicionado para 1–4 pasajeros, Sprinter vans para 5–16 pasajeros y autobuses para grupos de 17+. Todos los vehículos son modelos recientes y están totalmente licenciados para transporte turístico bajo la regulación SECTUR de México.'],
    ],
  },
  ...
  'groups': {
    en: [
      ['What group sizes do you accommodate for transportation?',
       'We handle groups from 10 to 50 passengers. For 10–16 passengers we use Mercedes Sprinter vans, 17–30 passengers go in Toyota Coasters, and 31–50 passengers ride in full-size tourist coaches. Larger groups (100+) can be split across multiple vehicles departing at the same time.'],
      ...
      ['Are vehicles equipped for long-distance group trips?',
       'Yes. All group vehicles have air conditioning, reclining seats, USB charging ports, and ample luggage space. Sprinter vans and coaches also include on-board restrooms on longer routes (Cancun to Chichén Itzá, Mérida, Bacalar). Professional bilingual drivers have SECTUR tourist transport licenses.'],
    ...
    es: [
      ['¿Qué tamaños de grupo manejan para transporte?',
       'Manejamos grupos de 10 a 50 pasajeros. Para 10–16 pasajeros usamos Mercedes Sprinter vans, 17–30 pasajeros en Toyota Coasters y 31–50 pasajeros en autobuses turísticos de tamaño completo. Grupos más grandes (100+) se dividen en múltiples vehículos con salida simultánea.'],
      ...
      ['¿Los vehículos están equipados para viajes grupales largos?',
       'Sí. Todos los vehículos grupales tienen aire acondicionado, asientos reclinables, puertos USB y amplio espacio para equipaje. Las Sprinter vans y autobuses también incluyen baños a bordo en rutas largas (Cancún a Chichén Itzá, Mérida, Bacalar). Choferes profesionales bilingües con licencia SECTUR de transporte turístico.'],
