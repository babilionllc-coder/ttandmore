  ...
  build: {
    rollupOptions: {
      input: {
        ...
        blogAirportPickupGuide: resolve(__dirname, 'blog/cancun-airport-pickup-guide/index.html'),
        blogWhereToStay: resolve(__dirname, 'blog/where-to-stay-cancun-riviera-maya/index.html'),
        // Blog pages (ES)
        ...
        esBlogAirportPickupGuide: resolve(__dirname, 'es/blog/cancun-airport-pickup-guide/index.html'),
        esBlogWhereToStay: resolve(__dirname, 'es/blog/where-to-stay-cancun-riviera-maya/index.html'),
      },
    },
  },
  server: {
